...
var linechartcustomerColors = getChartColorsArray("customer_impression_charts"), options = {
...
chart.render();
var chartDonutBasicColors = getChartColorsArray("store-visits-source"), options = {
...
var vectorMapWorldMarkersColors = getChartColorsArray("sales-by-locations"), worldemapmarkers = new jsVectorMap({
    map: "world_merc",
